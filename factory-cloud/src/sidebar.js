...
export const SIDEBAR_MODULES = Object.freeze([
  ...
  moduleItem("novel-peer-hits", "/novel-peer-hits", "同行爆款", ALL, novelPromotionGroup()),
  moduleItem("novel-ops-report", "/novel-ops-report", "数据概览", ALL, novelPromotionGroup()),
  moduleItem("novel-effects", "/novel-effects", "小说数据统计", ALL, novelPromotionGroup()),
...
export function moduleIdForPath(pathname) {
  ...
  const aliases = {
    ...
    "/psychology-photo": "psychology-photo",
  };
