...
function originalOf(source){
 ...
 const topComments=(Array.isArray(source.topComments)?source.topComments:[]).map(c=>typeof c==='string'?c:c?.text).filter(t=>typeof t==='string'&&t.trim()).slice(0,20);
