export const SIDEBAR_MODULES = Object.freeze([
  moduleItem("hub", "/", "业务总览", ["admin", "operator"]),
  ...
  moduleItem("novel-rewrite", "/novel-rewrite", "文案改写", ["admin"], novelPromotionGroup()),
  moduleItem("novel-effects", "/novel-effects", "小说效果", ["admin"], novelPromotionGroup()),
  moduleItem("rewrite-records", "/rewrite-records", "文案改写记录", ["admin"], novelPromotionGroup()),
  moduleItem("operator-official", "/operator/official", "小说自运营", ["admin"], novelPromotionGroup()),
  moduleItem("tasks", "/tasks", "Reddit 自动发布", ["admin", "operator"], novelPromotionGroup()),
